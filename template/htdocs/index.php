...
<acronym title="Entity 1"><a href=# title="Entity 1" onmouseover="hintstatus('Entity 1',this);" onclick="showview(0);"><img class="img-big1" src="imgs/t.gif" width="32" height="32"></a></acronym>
<div class="break"><span></span></div>
<acronym title="Entity 2"><a href=# title="Entity 2" onmouseover="hintstatus('Entity 2',this);" onclick="showview(1);"><img class="img-big2" src="imgs/t.gif" width="32" height="32"></a></acronym>
</span><!-- iconbuttons -->
...
<a href=# onclick="ajxjs(self.setaccountpass,'accounts.js');reloadtab('account','Account Settings','showaccount');addtab('account','Account Settings','showaccount');return false;">Account Settings</a>
</div>
</div><!-- logout -->
</div>
</div>
