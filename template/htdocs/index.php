...
<a class="noblink" id="applogo" ondblclick="if (!sconfirm('Are you sure you want to clone this window?')) return; window.open('./','','width=768,height=568,left=300,top=50,popup=yes,titlebar=no,menubar=no,location=no,toolbar=no,status=no');"><img src="<?php echo $codepage;?>?cmd=clogo" border="0" width="157"></a>
