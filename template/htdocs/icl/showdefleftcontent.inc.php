...
<?php
	if (!$quicklist){
		...
		<div style="text-align:center;">
			<button onclick="ajxpgn('defleftview',document.appsettings.codepage+'?cmd=setmyquicklist&quicklist=1');document.appsettings.quicklist=true;">Enable QuickList</button>
		</div>
		<?php
		...
		<div style="text-align:center;">
			<button onclick="ajxpgn('defleftview',document.appsettings.codepage+'?cmd=setmyquicklist&quicklist=0');document.appsettings.quicklist=false;">Disable QuickList</button>
		</div>
		<?php		
	}
?>
