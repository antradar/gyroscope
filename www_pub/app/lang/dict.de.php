...
$dict_mons=array('','Jan','Feb','März','Apr','Mai','Juni','Juli','Aug','Sept','Okt','Nov','Dez');
$dict_wdays=array('So','Mo','Di','Mi','Do','Fr','Sa');
$dict_dir='ltr';
...
$dict=array(
	...
	'switch_user'=>'Benutzer ändern',
	'invalid_password'=>'Ungültiges Passwort',
	'mismatching_password'=>'die zwei Passwörter müssen übereinstimmen',
	'must_provide_new_password'=>'bitte ein neues Password geben',
	'new_password_must_be_different'=>'Das neue Passwort muss sich von dem vorherigen unterscheiden',
	'password_changed'=>'Password geändert',
	
	'yearmonth'=>'%%mon%% %%year%%',
		
	'powered_by_'=>'powered by %%power%%',	
	'check_updates'=>'Version',
	'lookup_closer'=>'schließen',
	'pickup_edit'=>'ändern',
	
	'button_update'=>'Speichern',
	'button_delete'=>'Löschen',
	'button_user_add'=>'Hinzufügen',
	
	'account_roles'=>'Berechtigungen',
	'account_login_reset'=>'Passwort muss zurückgesetzt werden',
	...
	'csrf_expire'=>'Es ist schon eine Weile her, seit du diese Seite ge�ffnet wird. Melden Sie sich erneut an.'
