inithelptopictexteditor=function(helptopicid,st){
	...
	xajxjs('tinyMCE','tiny_mce/mceloader.js?v=2',function(){
		...
		tinyMCE.init({
			...
			mode : "textareas",
			theme : "advanced",
			plugins: 'paste, advimage', //layout_youtube,
			theme_advanced_buttons1:"medialib,objects,|,layout_headline,bold,italic,underline,strikethrough,|,forecolor,backcolor,|,bullist,numlist,|,outdent,indent,blockquote,|,link,unlink",
			...
			invalid_elements: 'button',
			extended_valid_elements : 'img[class|ampwidth|ampheight|src],a[href],b,em,strong,i,span[class],video[class|width|height|controls],source[src|type]',
