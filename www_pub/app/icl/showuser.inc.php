...
<div class="section hasqnav">
	...
	<div class="inputrow" id="bmuserroles_<?php echo $userid;?>">
		...
		foreach ($userroles as $role=>$label){
			...
			$padding+=20*($olen-$len);
		?>
		<div style="padding-left:<?php echo $padding;?>px;margin-bottom:3px;<?php if (in_array($role,$userrolelocks)&&!in_array($role,$groups)&&!isset($user['groups'][$role])) echo 'display:none;';?>">
