...
(function(){
	...
	if (!document.createComment) document.createComment=function(){return document.createElement('span');}; //patched by Schien, Antradar
...
(function(tinymce) {
	...
	tinymce.EditorManager = extend(tinymce, {
		...
		get : function(id) {
			...
			if (!this.editors.hasOwnProperty(id)){ //patched by Schien, Antradar
	...
	tinymce.create('tinymce.Editor', {
		...
		initContentBody : function() {
			...
			if ((!isIE || !tinymce.relaxedDomain) && !settings.content_editable) {
				//if (!tinyMCE.isWebKit){ // patched by Schien, Antradar
					doc.open();
