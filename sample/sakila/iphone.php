...
<div id="toolicons" style="position:fixed;width:100%;z-index:2000;top:0;border-bottom:solid 1px #dedede;">
	...
	<div class="menuitem"><a href=# onclick="showview(0,null,1);"><img class="img-actors" src="imgs/t.gif" border="0" width="32" height="32"></a></div>
	<div class="menuitem"><a href=# onclick="showview(1,null,1);"><img  class="img-films" src="imgs/t.gif" border="0" width="32" height="32"></a></div>
