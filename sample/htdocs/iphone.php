...
<div id="toolicons" style="position:fixed;width:100%;z-index:2000;top:0;border-bottom:solid 1px #dedede;">
	...
	<div class="menuitem"><a href=# onclick="showview(0);"><img src="imgs/bll<?echo $rhd;?>.gif" border="0" width="32"></a></div>
	<div class="menuitem"><a href=# onclick="showview(1);"><img src="imgs/bpr<?echo $rhd;?>.gif" border="0" width="32"></a></div>
	<div class="menuitem"><a href=# onclick="showview(2);"><img src="imgs/btn<?echo $rhd;?>.gif" border="0" width="32"></a></div>
	<div class="menuitem"><a href=# onclick="showview(3);"><img src="imgs/bls<?echo $rhd;?>.gif" border="0" width="32"></a></div>
